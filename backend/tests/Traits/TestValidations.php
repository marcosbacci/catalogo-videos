...
trait TestValidations
{
    ...
    protected function assertInvalidationsFields(TestResponse $response, array $fields, string $rule, array $rulesParams = [])
    {
        $response
            ->assertStatus(422)
        ...
        foreach ($fields as $field) {
            ...
            $response->assertJsonFragment([
                \Lang::get($rule, ['attribute' => $fieldName] + $rulesParams)
            ]);
        }
    }
}
